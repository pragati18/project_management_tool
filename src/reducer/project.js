...
const initialState = {
  ...
  lists: [
    {
      title: "Tapcliks",
      projectManager:"Pragati",
      startDate:"10th Jan 2020",
      endDate:"20th Jan 2020",
      id: 0
    },
    {
      title: "Tapcliks",
      projectManager:"Pragati",
      startDate:"25th Jan 2020",
      endDate:"20th Jan 2020",
      id: 1
    },
  ],
      ...
      return {
        ...
        lists: state.lists.map(list => {
          if (list.id !== action.payload.id) {
            ...
            return { ...list, title: action.payload.title, projectManager: action.payload.projectManager,startDate: action.payload.startDate,endDate:action.payload.endDate };
          }
        })
      };
